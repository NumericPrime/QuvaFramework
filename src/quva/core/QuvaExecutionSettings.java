...
public class QuvaExecutionSettings implements Serializable{
	...
	public static Map<String,String> settingsInstance=new HashMap<String,String>();
	...
	/**Adds a setting.
	 * @param setting setting to be used. Currently allowed settings are "token" and "samples"
